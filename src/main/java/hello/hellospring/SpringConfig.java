...
//    아래는 JPA를 사용할 때 필요했던 EntitiyManager를 주입받는 부분
    // @PersistenceContext // 원래 기존 스펙에서는 이렇게 주입받아야하는데 아래처럼 이번에는 그냥 스프링에서 주입받아 사용하자
//    private EntityManager em; // JPA에 필요한 EntityManager
//
//    @Autowired
...
//        return new MemberService(memberRepository()); // JDBC or JPA 사용시 필요
        return new MemberService(memberRepository); // Spirng Data JPA
    }

//    아래는 JDBC 혹은 기본JPA 사용시에 필요한 빈 등록
//    @Bean
